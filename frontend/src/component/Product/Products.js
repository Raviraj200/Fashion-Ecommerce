...
const Products = ({ match }) => {
    ...
    const { products, loading, error, productsCount, resultPerPage ,filteredProuctsCount} = useSelector(
    ...
    let count =filteredProuctsCount;
...
{/* per page***************************************************************************************************************************************** */}
            {resultPerPage < count && <div className="pagintionBox">
